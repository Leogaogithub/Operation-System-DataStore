...
public class ExampleClient
{
	...
	static public void main(String args[]) throws ClientException, UnknownHostException{
		byte byteAddr[] = {127, 0, 0, 1}; // Server Address
		InetAddress address  = InetAddress.getByAddress(byteAddr);
		ExampleClient client = new ExampleClient(address, 10023);
		String xxx = "Oh my god";
		String result = client.reverse(xxx);
